// Generated from ONNX "/home/edward/Documents/workspaces/dev/model-archive/onnx_models/stardist_2d_versatile_fluo_fixed.onnx" by burn-import
use burn::prelude::*;
...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        Self::from_file(
            concat!(env!("CARGO_MANIFEST_DIR"), "/pretrained_models/stardist_2d_versatile_fluo_fixed.bin"),
            &Default::default(),
        )
    }
}
...
impl<B: Backend> Model<B> {
    ...
    pub fn forward(&self, input1: Tensor<B, 1>) -> (Tensor<B, 4>, Tensor<B, 4>) {
        ...
        let reshape8_out1 = sigmoid1_out1.reshape([1, 256, 256, 1]);
